		...
		<div class="content-services">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="single-service">
						<div class="img-service">
							<img src="<?php echo get_bloginfo('template_url'); ?>/img/icons/icon-sac.png" alt="">
						</div>
						<h3 class="title-service">
							SAC
						</h3>
						<p class="text-service">
							Solucione suas dúvidas ou deixe sugestões
						</p>
						<div class="link-service">
							<a href="<?php echo get_page_link(InfoVar::show('sac')); ?>">
							Enviar Mensagem
							</a>
						</div>
					</div>
