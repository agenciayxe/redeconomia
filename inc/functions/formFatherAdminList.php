...
function father_options() {
    ...
    $AllBookings = $wpdb->get_results(
        "SELECT * FROM form_father {$actionPesquisa}"
    );
    ...
    if (!$action) {
        $bookingList = $wpdb->get_results(
            "SELECT * FROM form_father {$actionPesquisa} ORDER BY date_created DESC LIMIT {$quantityPage} OFFSET {$offsetPage}"
        );
        ?>
        <div class="wrap">
            <h2>Cadastro</h2>
                ...
                <div id="post-body" class="metabox-holder columns-3">
                    <form action="">
                        <p class="search-box">
                            ...
                            <input type="hidden" name="page" value="form-father">
                    ...
                    <div id="post-body-content">
                        <div class="meta-box-sortables ui-sortable">
                            <form method="post">
                                ...
                                <input type="hidden" name="_wp_http_referer" value="?page=form-father">
                                <?php 
                                if ($totalPage > 1) {
                                    ?>
                                        ...
                                        <div class="tablenav-pages">
                                            ...
                                            <span class="pagination-links">
                                                ...
                                                if ($page == 1) {
                                                    ...
                                                    ?>
                                                    <a class="next-page" href="?page=form-father&amp;p=<?php echo 1; ?>">
                                                        <span class="screen-reader-text">Página anterior</span>
                                                        <span aria-hidden="true">«</span>
                                                    </a>
                                                    <a class="last-page" href="?page=form-father&amp;p=<?php echo $page-1; ?>">
                                                ...
                                                if ($page == $totalPage) {
                                                    ...
                                                    ?>
                                                    <a class="next-page" href="?page=form-father&amp;p=<?php echo $page + 1; ?>">
                                                        <span class="screen-reader-text">Próxima página</span>
                                                        <span aria-hidden="true">›</span>
                                                    </a>
                                                    <a class="last-page" href="?page=form-father&amp;p=<?php echo $totalPage; ?>">
                                            ...
                                            foreach ($bookingList as $bookingCurrent) {
                                                ...
                                                <tr id="post-20" class="iedit author-self level-0 post-20 type-page status-publish hentry">
                                                    ...
                                                    <td class="title column-title has-row-actions column-primary page-title" data-colname="Título">
                                                        ...
                                                        <strong>
                                                            <a class="row-title" href="?page=form-father&action=view&id=<?php echo $bookingCurrent->id; ?>">
    ...
    <?php
        ...
        $promotionList = $wpdb->get_results(
            $wpdb->prepare(
                "SELECT * FROM form_father WHERE id='%s'",
                $id
            )
        );
                ...
                <div class="teetime-booking row">
                    <div id="post-body" class="teetime-column col-10">
                        ...
                        <table class="table-teetime-booking">
                            ...
                            <tr><td><strong>Nome do Pai</strong></td><td><?php echo $promotionCurrent->father; ?></td></tr>
                            ...
                            <tr><td><strong>Loja</strong></td><td><?php echo $promotionCurrent->store; ?></td></tr>
                            <tr><td><strong>Mensagem</strong></td><td><?php echo $promotionCurrent->message; ?></td></tr>
                            <tr><td><strong>Foto</strong></td><td><img src="<?php echo $promotionCurrent->photo; ?>" width="100%" alt=""></td></tr>
                        </table>
