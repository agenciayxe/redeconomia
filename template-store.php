...
*/
get_header(); 
get_template_part('templates/ads', 'store');
?>
<main class="page page-stores">
	<div class="container">
		<div class="list-stores">
			<div class="row">
				<div class="col-md-4">
					<select name="lojas" id="lojas" class="input-contato">
						<option disabled selected>Selecione um local</option>
						<?php
						$locaisTaxonomy = get_terms( 'lojas' );
						foreach ($locaisTaxonomy as $singleTaxonomy) {
							?><option value="<?php echo $singleTaxonomy->slug; ?>"><?php echo $singleTaxonomy->name; ?></option><?php
						}
						?>
					</select>
				</div>
				<div class="col-md-8">	
					<div class="bg-light text-uppercase py-2 px-3"><h4><i class="fas fa-chevron-circle-left"></i> Clique para encontrar uma loja</h4></div>
				</div>
			</div>
			<div id="store-list">
