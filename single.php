...
<main>
	<div class="container">
		...
		<a onclick="window.history.go(-1); return false;"><button type="button">Voltar</button></a><a href="<?php echo get_post_type_archive_link('dicas'); ?>"><button type="button">Ver Outras Dicass</button></a>
